...
sections:
  # ────────────────────────────────────────────────────────────────────────────
  # 1. Custom CSS for Navbar (Green background, White active state)
  # ────────────────────────────────────────────────────────────────────────────
  - block: markdown
    content:
      text: |
        <style>
          /* Navbar background: Teal Green */
          .navbar { 
          ...
          /* Active/Hover state: White background, Green text */
      ...
      text: |
        <div style="display: flex; flex-wrap: wrap; gap: 50px; align-items: flex-start; padding: 20px 0;">
          ...
          <div style="flex: 1; min-width: 320px;">
            ...
            <a href="https://www.google.com/maps/dir/?api=1&destination=11+Rue+Pierre+et+Marie+Curie+75005+Paris+France" 
               target="_blank" 
               style="display: inline-block; padding: 14px 28px; background-color: #008a85; color: white; border-radius: 8px; text-decoration: none; font-weight: 600; transition: 0.3s; box-shadow: 0 4px 12px rgba(0,138,133,0.2);">
          ...
          <div style="flex: 1.4; min-width: 320px;">
            <div style="border-radius: 20px; overflow: hidden; box-shadow: 0 15px 35px rgba(0,0,0,0.12); border: 1px solid #eee;">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2625.5681434316043!2d2.342371776928682!3d48.84449830150961!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e671e626e2e46d%3A0x6a0f67977464a38e!2s11%20Rue%20Pierre%20et%20Marie%20Curie%2C%2075005%20Paris%2C%20France!5e0!3m2!1sen!2sfr!4v1700000000000!5m2!1sen!2sfr" 
                width="100%" 
                height="450" 
